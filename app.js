...
The [Em]hour I [D]first be[G]lieved`;
  ...
  function bindEvents() {
    ...
    // Naadan Chords import (button sits inside card-create, so stop propagation)
    if (el.cardNaadan) el.cardNaadan.addEventListener('click', e => { e.stopPropagation(); openNaadanModal(); });
    if (el.naadanModal) {
